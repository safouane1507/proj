...
<div style="max-width: 600px; margin: 40px auto;">
    <div class="card" style="padding: 30px; border-radius: 16px; border: 1px solid var(--border); background: var(--bg-surface);">
        ...
        <form action="<?php echo e(route('user.custom.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <?php endif; ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="datetime-local" id="start_date" name="start_date" required style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--border); background: var(--bg-background); color: var(--text-primary); <?php $__errorArgs = ['start_date'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('start_date')); ?>">
                ...
                <div>
                    ...
                    <input type="datetime-local" id="end_date" name="end_date" required style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--border); background: var(--bg-background); color: var(--text-primary); <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-color: red; <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('end_date')); ?>">
    ...
    <div style="text-align: center; margin-top: 20px;">
        <a href="<?php echo e(route('user.dashboard')); ?>" style="color: var(--text-muted); text-decoration: none; font-size: 0.9rem;">Annuler et retour</a>
    </div>
</div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJET DEV\Project Dev\resources\views/user/custom_create.blade.php ENDPATH**/ ?>