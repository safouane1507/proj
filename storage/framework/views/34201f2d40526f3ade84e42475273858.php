...
<div style="max-width: 1000px; margin: 0 auto; padding-bottom: 50px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="<?php echo e(route('reservations.create')); ?>" class="btn" style="text-decoration: none; padding: 10px 20px; background-color: #00796b; color: white; border: none; border-radius: 8px;">
                + Nouvelle Réservation
            </a>
            <a href="<?php echo e(route('user.custom.create')); ?>" class="btn btn-primary" style="text-decoration: none; padding: 10px 20px;">
                ✨ Config. sur mesure
            </a>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 25px; border-left: 5px solid var(--primary);">
        ...
        <?php if($myCustomRequests->isEmpty()): ?>
        ...
        <?php else: ?>
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <?php $__currentLoopData = $myCustomRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="border-top: 1px solid var(--border);">
                        <td style="padding: 10px; font-weight: 600;"><?php echo e($custom->type); ?></td>
                        <td style="padding: 10px; font-size: 0.85rem;">CPU: <?php echo e($custom->cpu); ?> | RAM: <?php echo e($custom->ram); ?></td>
                        <td style="padding: 10px;">
                            ...
                            <div style="display:inline-flex; align-items:center; gap:6px;">
                                <span style="font-weight:700; font-size:0.82rem; padding:3px 10px; border-radius:20px; color:<?php echo e($cs['color']); ?>; background:<?php echo e($cs['bg']); ?>;">
                                    <?php echo e($cs['label']); ?>

                                </span>
                                <?php if($custom->status === 'rejected' && !empty($custom->manager_feedback)): ?>
                                    <span class="tooltip-wrap">
                                        <span class="tooltip-icon">?</span>
                                        <span class="tooltip-text"><?php echo e($custom->manager_feedback); ?></span>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </td>
    ...
    <div class="card">
        ...
        <?php else: ?>
            <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                ...
                <tbody>
                    <?php $__currentLoopData = $myReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border-bottom: 1px solid var(--border);">
                            <td style="padding: 12px; font-weight: bold; color: var(--primary);"><?php echo e($reservation->resource->label); ?></td>
                            <td style="padding: 12px; font-size: 0.85rem;">Du <?php echo e(\Carbon\Carbon::parse($reservation->start_date)->format('d/m/Y')); ?><br>Au <?php echo e(\Carbon\Carbon::parse($reservation->end_date)->format('d/m/Y')); ?></td>
                            <td style="padding: 12px;">
                                ...
                                ?>
                                <div style="display:inline-flex; align-items:center; gap:6px;">
                                    <span style="font-weight:700; font-size:0.82rem; padding:3px 10px; border-radius:20px; color:<?php echo e($ss['color']); ?>; background:<?php echo e($ss['bg']); ?>;">
                                        <?php echo e($ss['label']); ?>

                                    </span>
                                    <?php if($reservation->status === 'rejected' && $reservation->manager_feedback): ?>
                                        <span class="tooltip-wrap">
                                            <span class="tooltip-icon">?</span>
                                            <span class="tooltip-text"><?php echo e($reservation->manager_feedback); ?></span>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </td>
    ...
    <div class="card" style="margin-top: 30px; border-left: 5px solid #d63031;">
        ...
        <form action="<?php echo e(route('incidents.store')); ?>" method="POST" style="display: grid; gap: 15px;">
            <?php echo csrf_field(); ?>
            <div>
        ...
        <?php if(isset($myIncidents) && $myIncidents->count() > 0): ?>
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid var(--border);">
                <h4 style="margin-bottom: 10px;">Vos signalements récents :</h4>
                <ul style="list-style: none; padding: 0;">
                    <?php $__currentLoopData = $myIncidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li style="padding: 10px; background: var(--bg-background); border-radius: 6px; margin-bottom: 10px; display: flex; justify-content: space-between; align-items: center;">
                            <span><strong><?php echo e($inc->subject); ?></strong> <span style="font-size: 0.8rem; color: var(--text-muted);">(<?php echo e($inc->created_at->diffForHumans()); ?>)</span></span>
                            <span style="font-size: 0.8rem; font-weight: bold; padding: 2px 8px; border-radius: 10px; background: <?php echo e($inc->status == 'resolved' ? '#e8f5e9' : '#ffebee'); ?>; color: <?php echo e($inc->status == 'resolved' ? '#2ecc71' : '#c62828'); ?>;">
                                <?php echo e($inc->status == 'resolved' ? '✅ Résolu' : '⏳ En cours'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJET DEV\Project Dev\resources\views/user/dashboard.blade.php ENDPATH**/ ?>