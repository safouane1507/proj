...
<div style="max-width: 600px; margin: 50px auto;">
    <div class="card">
        ...
        <?php if(session('success')): ?>
            <div style="background: #e8f5e9; color: green; padding: 10px; border-radius: 5px; margin-bottom: 15px;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJET DEV\Project Dev\resources\views/profile/settings.blade.php ENDPATH**/ ?>