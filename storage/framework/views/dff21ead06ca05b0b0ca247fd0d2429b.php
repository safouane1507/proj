...
<div style="max-width: 1200px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px; flex-wrap: wrap; gap: 20px;">
        <div>
            ...
            <p style="color: var(--text-muted); margin-top: 5px;">
                <?php if(request('cat')): ?> Filtré par : <strong><?php echo e(request('cat')); ?></strong> <?php else: ?> Toutes les ressources <?php endif; ?>
            </p>
        </div>
        
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            <a href="<?php echo e(route('resources.all')); ?>" class="btn <?php echo e(!request('cat') ? 'btn-primary' : 'btn-outline'); ?>">Tout</a>
            <a href="<?php echo e(route('resources.all', ['cat' => 'Serveur Physique'])); ?>" class="btn <?php echo e(request('cat') == 'Serveur Physique' ? 'btn-primary' : 'btn-outline'); ?>">Serveurs</a>
            <a href="<?php echo e(route('resources.all', ['cat' => 'Machine Virtuelle'])); ?>" class="btn <?php echo e(request('cat') == 'Machine Virtuelle' ? 'btn-primary' : 'btn-outline'); ?>">VMs</a>
            <a href="<?php echo e(route('resources.all', ['cat' => 'Stockage'])); ?>" class="btn <?php echo e(request('cat') == 'Stockage' ? 'btn-primary' : 'btn-outline'); ?>">Stockage</a>
            <a href="<?php echo e(route('resources.all', ['cat' => 'Réseau'])); ?>" class="btn <?php echo e(request('cat') == 'Réseau' ? 'btn-primary' : 'btn-outline'); ?>">Réseau</a>
        </div>
    </div>
    ...
    <?php if($resources->isEmpty()): ?>
        <div style="text-align: center; padding: 80px; background: var(--bg-surface); border-radius: 16px; border: 2px dashed var(--border);">
            ...
            <a href="<?php echo e(route('resources.all')); ?>" class="btn btn-primary">Voir tout</a>
        </div>
    <?php else: ?>
            ...
            <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card" style="display: flex; flex-direction: column; transition: transform 0.2s; border: 1px solid var(--border); background: var(--bg-surface); border-radius: 12px; padding: 20px;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                        <span style="font-size: 0.75rem; font-weight: 800; color: var(--primary); text-transform: uppercase;"><?php echo e($resource->category); ?></span>
                        <span style="font-size: 0.75rem; color: <?php echo e($s['color']); ?>; font-weight: bold; background: <?php echo e($s['bg']); ?>; padding: 2px 8px; border-radius: 10px;"><?php echo e($s['label']); ?></span>
                    </div>
                    
                    <h3 style="margin: 0 0 10px 0; font-size: 1.3rem; color: var(--text-primary);"><?php echo e($resource->label); ?></h3>
                    <p style="font-size: 0.9rem; color: var(--text-muted); flex-grow: 1; margin-bottom: 20px;">
                        <?php echo e(Str::limit($resource->description ?? 'Aucune description', 80)); ?>
                    ...
                    <div style="padding-top: 15px; border-top: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center; gap: 8px; flex-wrap:wrap;">
                        <span style="font-size: 0.85rem; font-weight: 600; color: var(--text-muted);">📍 <?php echo e($resource->location); ?></span>
                        ...
                        <div style="display:flex; gap:8px; align-items:center;">
                            ...
                            <button class="btn-details"
                                    ...
                                    data-label="<?php echo e(e($resource->label)); ?>"
                                    data-category="<?php echo e(e($resource->category)); ?>"
                                    data-location="<?php echo e(e($resource->location)); ?>"
                                    data-description="<?php echo e(e($resource->description)); ?>"
                                    data-status="<?php echo e($resource->status); ?>"
                                    data-status-label="<?php echo e($s['label']); ?>"
                                    data-status-color="<?php echo e($s['color']); ?>"
                                    data-condition="<?php echo e($cond['label']); ?>"
                                    data-condition-color="<?php echo e($cond['color']); ?>"
                                    data-specs='<?php echo e($specs); ?>'
                                    data-periods='<?php echo e($periods); ?>'
                                    data-history='<?php echo e($history); ?>'
                                    data-reserveurl="<?php echo e($resource->status == 'available' ? route('reservations.create', ['resource_id' => $resource->id]) : ''); ?>"
                                    data-canreserve="<?php echo e((!Auth::check() || Auth::user()->role === 'user') && $resource->status === 'available' ? '1' : '0'); ?>">
                                🔍 Détails
                            </button>

                            <?php if(!Auth::check() || Auth::user()->role === 'user'): ?>
                                <?php if($resource->status == 'available'): ?>
                                    <a href="<?php echo e(route('reservations.create', ['resource_id' => $resource->id])); ?>" class="btn btn-primary" style="padding: 6px 14px; font-size: 0.9rem;">Réserver</a>
                                <?php else: ?>
                                    <button disabled style="padding: 6px 14px; font-size: 0.85rem; background: #f8f9fa; color: #636e72; border: 1px solid #dfe6e9; border-radius: 8px; cursor: not-allowed; font-weight: bold;">
                                        <?php echo e($resource->status == 'maintenance' ? '🔧 Maintenance' : '⛔ Hors Service'); ?>
    ...
    <div class="modal-box">
        ...
        <div class="modal-header">
            ...
            <div style="display:flex; flex-direction:column; align-items:flex-end; gap:6px;">
                ...
                <span id="mCondBadge" class="modal-badge-outline"></span>
            </div>
        </div>
        ...
        <div class="modal-tabs">
            ...
            <?php if(Auth::check() && in_array(Auth::user()->role, ['admin', 'manager'])): ?>
        ...
        <div id="tab-avail" class="tab-content">
            <div class="specs-grid">
                ...
                <div class="spec-card"><div class="spec-key">État</div><div id="mAvailCond" class="spec-val"></div></div>
...
function openModal(btn) {
    ...
    const cb = document.getElementById('mCondBadge');
    cb.textContent = d.condition;
    cb.style.color = d.conditionColor;
    cb.style.borderColor = d.conditionColor + '88';
    ...
    document.getElementById('mAvailCond').innerHTML   = `<span style="color:${d.conditionColor};font-weight:700;">${d.condition}</span>`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJET DEV\Project Dev\resources\views/resources.blade.php ENDPATH**/ ?>